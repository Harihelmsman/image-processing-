...
class BatchLabeledEditor:
    ...
    def __init__(self, input_folder, output_folder=None):
        ...
        self.scaled_image           = None   # view into original_image (no copy)
        ...
        # ── label overlay cache — reused across pan/zoom, only rebuilt on edit ─
        self._label_overlay         = None   # uint8 array same size as output_image
        self._label_overlay_valid   = False  # False → rebuild next frame
    ...
    def _load_current_image(self):
        ...
        try:
            ...
            self._label_overlay_valid = False
    ...
    def _apply_all_effects(self):
        self.output_image = self.original_image.copy()  # one copy, base for edits
        ...
        self._label_overlay_valid = False   # circles changed → rebuild label cache
